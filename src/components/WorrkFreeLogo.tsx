    ...
    <div className={`shrink-0 flex items-center justify-center ${className}`} style={{ width: 36, height: 36 }}>
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <linearGradient id="shineGradient" x1="18" y1="0" x2="18" y2="18" gradientUnits="userSpaceOnUse">
        ...
        {/* Main Background */}
        <rect width="36" height="36" rx="12" fill="url(#bgGradient)" />
        
        {/* Subtle Shine/Gloss on top half */}
        <path d="M0 12C0 5.37258 5.37258 0 12 0H24C30.6274 0 36 5.37258 36 12V16C28 12 18 12 0 16V12Z" fill="url(#shineGradient)" />
