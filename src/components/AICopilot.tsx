            ...
            <form onSubmit={handleGenerateRoadmap} className="space-y-4">
              <div>
                <textarea
                  ...
                  required
                  rows={3}
                  className="w-full px-3.5 py-2.5 text-xs glass-input rounded-xl placeholder:text-slate-400"
                />
              </div>
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  disabled={loading}
                  className="px-5 py-2.5 glass-button-primary disabled:bg-white/10 disabled:text-slate-400 disabled:border-white/10 text-white font-bold text-xs rounded-full transition-all shadow-xs flex items-center gap-1.5"
                >
        ...
        <div className="md:col-span-5 space-y-6">
          ...
          <div className="bg-white/20 backdrop-blur-md rounded-2xl border border-white/30 p-6 shadow-2xs">
            ...
            <button
              ...
              className="w-full py-2.5 glass-button-primary text-white font-bold text-xs rounded-full shadow-xs transition-colors"
            >
